...
Period coverage:
  ...
  Active   : Nov 2025 – Apr 2026  (6 months, all clean)

All data is clean — no seeded DQ issues. For demos, DQ issues are
entered live in DHIS2 during the presentation (see dhis2_setup_guide.md,
Phase 5 and the UX doc demo script for exact values and navigation).
...
seed derived from hashlib.md5(facility_name:period). Adding or reordering
periods never changes values for other cells.
...
print('=' * 60)
print('Phase 5: Injecting synthetic EPI data (all clean)')
...
n_expected = len(facilities) * len(PERIODS)
print('\n' + '=' * 60)
print('Phase 5 COMPLETE')
print(f'  Data points submitted : {total_ok} / {n_expected}')
print(f'  Errors                : {len(log["errors"])}')
print()
print('  All data is clean. DQ issues are entered live during the demo.')
print('  See dhis2_setup_guide.md and the UX doc for demo instructions.')
print()
